<x-layouts.app title="Редактирование новости">
    <x-slot name="content">
        <x-title-header title="Редактирование новости" />
        <div class="container">
            <x-button-back />
            ...
            <div class="pt-4 pb-2">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group pt-2">
                        ...
                        <input type="text" name="title" class="form-control" minlength="3" maxlength="250"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="preview_text" class="form-control" minlength="3"
